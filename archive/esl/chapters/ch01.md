...
$$
\text{if } (\%\text{george} < 0.6) \,\&\, (\%\text{you} > 1.5) \text{ then spam else email.}
$$
...
(scatterplot matrix figure omitted)
...
Example 2: Prostate Cancer The data for this example, displayed in Figure 1.11 , come from a study by Stamey et al. (1989) that examined the correlation between the level of
...
(microarray heat-map figure omitted — sample gene labels: SIDW299104, SIDW380102, ..., SID42354; sample tissue labels: BREAST, RENAL, MELANOMA, ..., UNKNOWN)
