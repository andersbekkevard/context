...
Personal exam-prep system for **TMA4268 *Statistisk læring*** (NTNU, final exam 2026-05-18). The repo holds the raw course corpus alongside an LLM-generated wiki; together they form a context layer an LLM tutor can query, and a Quartz-rendered site friends can browse. Available at [statistical.dog](https://statistical.dog)
