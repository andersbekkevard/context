...
- The exercise should be handed in as two files: **one pdf file with your main report and a supplementary file with your code (.R of .py)** We will read the pdf-file and use the code file in case we need to check details in your submission.
