...
- **Skip in ISLR:** specifics of the t- and F-distributions are referenced but not derived; ISLR is light here. Walpole is the prof's recommended classical reference for the $\chi^2_{n-p-1}$ distribution of $\hat\sigma^2$ if you want it.
