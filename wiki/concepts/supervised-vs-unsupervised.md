...
- **Short answer**: "give an example of an 'unsupervised' problem that is really supervised" — LLM next-word, autoencoder reconstruction, click prediction. Or "when is unsupervised analysis defensible?" — when tied to a downstream supervised validation.
