...
ISL's worked example: **wide data** with many more predictors than samples ($p \gg n$). Common in genetics / protein data, sometimes in finance - *"you can imagine you only have a year's worth of stock-trading data but you have a million stocks."* The setting amplifies a problem that exists more generally.
