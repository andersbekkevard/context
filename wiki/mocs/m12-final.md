...
## Scope authority
- [[../../docs/scope|docs/scope]] — the canonical "is X in scope?" reference: source hierarchy (exercises > lectures > slides; ISLR for fleshing out, not for scoping), explicit exclusions with verbatim anchors, programming policy, 2026 question patterns, past-exam translation table, exam logistics

## Cross-cutting concepts touched (Specials)

These are the six cross-module atoms that any module-12 query will likely route through. Each is owned by no single module — they thread through the whole course.
...
Drawn from [[L27-summary]]'s walkthrough plus the signals catalogued in [[../../docs/scope|docs/scope]]. These are the atoms most likely to anchor an exam question:
