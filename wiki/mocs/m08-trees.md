...
## ISLR pointer
Chapter 8: Tree-Based Methods. Deep treatment of every in-scope concept lives in `book/08-trees.md`; specific atoms carry section-level `isl-ref:` pointers. Note ISLR ch. 8 also covers boosting — that's module 09's territory, not this MOC's.
