...
\begin{enumerate}[(1)]
  \item \textbf{validation} (2nd option)
  \item \textbf{cross-validation} (3rd option)
  \item \textbf{bootstrap} (1st option)
  \item \textbf{forward stepwise} (4th option)
  \item \textbf{lasso} (2nd option)
  \item \textbf{sparse} (1st option)
  \item \textbf{principal component analysis} (4th option)
  \item \textbf{local} (3rd option)
  \item \textbf{dendrogram} (2nd option)
  \item \textbf{boosting} (1st option)
\end{enumerate}
...
\begin{enumerate}[(i)]
  ...
  \item \textbf{False}. The probability $1/e \approx 0.368$ is the probability that observation $i$ is \emph{absent} from the bootstrap sample: $P(\text{obs } i \notin \text{sample}) = (1-1/n)^n \to 1/e$. So the probability that observation $i$ \emph{does} appear approaches $1 - 1/e \approx 0.632$, not $0.368$.
